        ...
        <div class="row g-0 min-vh-100">
            ...
            <div class="col-lg-6 left-section animate__animated animate__fadeIn">
                ...
                <div class="create-account">
                    <span>Não tem uma conta? <a href="#" class="create-account-link">Crie uma! <i class="fas fa-arrow-right"></i></a></span>
                </div>
            ...
            <div class="col-lg-6 right-section animate__animated animate__fadeIn">
                ...
                <p class="testimonial-author"><img src="img/homem_.jpg" id="homem_">  Carlos M., Investidor desde 2021</p>
